...
echo_and_run cd "/home/jose/Escritorio/VAR/p2/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jose/Escritorio/VAR/p2/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/jose/Escritorio/VAR/p2/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
